...
if page == "Home":
    ...
    if uploaded_image is not None:
        ...
        st.image("Joy.jpg", width=150, caption="Default Profile Picture")

    # Student Details
    name = st.text_input("Your Name", "GIHOZO Brigitte")
...
# Projects section
    ...
    project_data = {
        "Year 1 Project": {
            "📊 kits": {
                "type": "Individual",
                "description": "A project analyzing digital kits .",
                "link": "https://github.com/gihozo21/kits"
            }
        },
        "Year 2 Project": {
            "🤖 Embroidery-Kits": {
                ...
                "link": "https://github.com/gihozo21/Embroidery-Kits"
            }
        },

        "Dissertation": {
            "🌍 A SYSTEM PREDICTION OF EPILYPSE DEASES BY USING LINEAR REGRESSION ": {
                "type": "Individual",
                "description": "Analysising and developing the system.",
                "link": "https://github.com/gihozo21/Dissertation"
            }
        }
    }
...
# Contact Page
    ...
    st.title("📬 Contact Me")
    st.write("📧 Email: gihozobrigittejoy@gmail.com")
    st.write("🔗 [LinkedIn](https://www.linkedin.com/in/gihozobrigitte)")
    st.write("📂 [GitHub](https://github.com/gihozo21)")

st.sidebar.write("---")
st.sidebar.write("Designed by Brigitte under the supervision of M Clement")
